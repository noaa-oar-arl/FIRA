...
for i in np.arange(TT):
    ...
    if opt_inputgen == 1:
        ...
        code = fire_inputgen.main_driver(initial_time, i, f_frp, f_input, lat_lim, lon_lim)
        if code == 0:
    ...
    if opt_evaluation == 1:
        ...
        code = fire_evaluation.main_driver(f_output, frp_source, opt_intensity, lat_lim, lon_lim)
        if code == 0:
